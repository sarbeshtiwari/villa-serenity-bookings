  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium font-body transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-accent text-accent-foreground font-semibold shadow-lg hover:shadow-xl hover:-translate-y-1 hover:bg-accent/90 tracking-wide uppercase text-xs",
        whatsapp: "bg-[hsl(142,70%,49%)] text-primary-foreground font-semibold shadow-lg hover:shadow-xl hover:-translate-y-1 hover:bg-[hsl(142,70%,42%)]",
        luxury: "bg-primary/10 text-primary border border-primary/30 backdrop-blur-sm hover:bg-primary hover:text-primary-foreground",
      },
      size: {
