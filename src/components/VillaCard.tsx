...
export const VillaCard = ({
  ...
  return (
    <div className="group bg-card rounded-xl overflow-hidden card-luxury">
      {/* Image */}
      ...
      <div className="p-6">
        ...
        <div className="flex gap-3">
          <Link to={`/villas/${id}`} className="flex-1">
          ...
          <Button
            ...
            onClick={() =>
              window.open(
                `https://wa.me/919607382020?text=Hi! I'm interested in booking ${name}`,
                "_blank"
              )
            }
          >
